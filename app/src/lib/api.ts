...
export const serversApi = {
  ...
  create: async (data: { name: string; host: string; sshKey?: string; sshUser?: string; baseDomain?: string; autoDomains?: boolean; hostKey?: string; hostKeyFingerprint?: string; proxyMode?: 'managed' | 'external' }): Promise<Server> => {
